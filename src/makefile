...
# operating system:  Linux 4.19.58-v7l+ armv7l [ELF] (4.19.58)
# libc:	(6.28.0)
# binutils:	(231)
...
LOCAL_LIBRARIES = $(XAWLIB) $(XMULIB) $(XPMLIB) $(XTOOLLIB) $(XLIB)
SRCS = x026.c
OBJS = x026.o
...
install:: x026
	...
	$(INSTALL) $(INSTALLFLAGS) $(INSTPGMFLAGS)  x026 $(DESTDIR)$(BINDIR)/x026

all:: x026.$(MANNEWSUFFIX)

x026.$(MANNEWSUFFIX): x026.$(MANSRCSUFFIX)
	$(RM) $@
	if test -z "$(PREPROCESSMANPAGES)" ; then \
	   cd `dirname x026` && \
	   $(LN) `basename x026.$(MANSRCSUFFIX)` `basename $@`; \
	else \
	      	     $(RAWCPP)  $(MANDEFS) $(EXTRAMANDEFS) \
	     < x026.$(MANSRCSUFFIX) | sed -e '/^#  *[0-9][0-9]*  *.*$$/d' 			-e '/^#line  *[0-9][0-9]*  *.*$$/d' 			-e '/^[ 	]*XCOMM$$/s/XCOMM/#/' 			-e '/^[ 	]*XCOMM[^a-zA-Z0-9_]/s/XCOMM/#/' 			-e '/^[ 	]*XHASH/s/XHASH/#/' 			-e '/\@\@$$/s/\@\@$$/\\/' >$@; \
	fi

cleandir::
	$(RM) x026.$(MANNEWSUFFIX)

install.man:: x026.$(MANNEWSUFFIX)
	...
	$(INSTALL) $(INSTALLFLAGS) $(INSTMANFLAGS) x026.$(MANNEWSUFFIX) $(DESTDIR)$(MANDIR)/x026.$(MANSUFFIX)
...
# DO NOT DELETE
x026.o: x026.c /usr/include/stdc-predef.h /usr/include/stdio.h \
 ...
 /usr/include/X11/StringDefs.h /usr/include/X11/Shell.h \
 /usr/include/X11/SM/SMlib.h /usr/include/X11/SM/SM.h \
 /usr/include/X11/ICE/ICElib.h /usr/include/X11/ICE/ICE.h \
 /usr/include/X11/Xatom.h /usr/include/X11/Xaw/Command.h \
 /usr/include/X11/Xaw/Label.h /usr/include/X11/Xaw/Simple.h \
 /usr/include/X11/Xmu/Converters.h /usr/include/X11/Xaw/Dialog.h \
 /usr/include/X11/Xaw/Form.h /usr/include/X11/Xaw/Porthole.h \
 /usr/include/X11/Xaw/Reports.h /usr/include/X11/xpm.h collins.xpm \
 carnegie2.xpm hole.xpm x026.bm
